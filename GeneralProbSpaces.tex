...
We start with the smaller infinity, the countable infinity of the of the natural numbers.
...
To define the geometric distribution we need that the infinite sum of
